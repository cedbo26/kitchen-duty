...
`;
    ...
    while (currentYear < endISOWeek.year ||
        ...
        // Événement le lundi à 20h (heure locale convertie en UTC)
        const eventStart = new Date(Date.UTC(
            monday.getFullYear(),
            monday.getMonth(),
            monday.getDate(),
            19, // 20h Europe/Zurich = 19h UTC (heure d'hiver) ou 18h UTC (heure d'été)
            0,
            0
        ));
